#
#  Be sure to run `pod spec lint ZJUnFoldView.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # Or just: s.author    = "Abnerzj"
  # s.authors            = { "Abnerzj" => "Abnerzj@163.com" }
  ...
  s.exclude_files = "ZJUnFoldView/Exclude"
